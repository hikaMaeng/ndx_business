...
export class MetricsRegistry {
  private readonly counters: MetricsSnapshot = {
    ...
    ingressAccepted: 0, brokerReadFailures: 0, routerUnmatchedResults: 0, processingDlqTotal: 0, queueVisibilityRenewFailures: 0,
  ...
  setGauge(name: "websocketConnections" | "websocketMailboxQueued" | "databasePoolTotal" | "databasePoolIdle" | "databasePoolWaiting" | "queuePoolTotal" | "queuePoolIdle" | "queuePoolWaiting", value: number): void { this.counters[name] = value; }
