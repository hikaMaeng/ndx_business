...
const deadline = Date.now() + 120_000; let snapshot;
...
console.log(JSON.stringify({ test: "multichannel-load", total, concurrency, channels: channels.length, submitMs, accepted, metrics: snapshot }));
