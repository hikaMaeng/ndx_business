// Target: apps/vibeagent/src/front/model/useModel.ts   (React glue, app side)
//
...
//   import type { Emitter } from "vibeagent_domain/front/model/Emitter";
import type { Emitter } from "vibeagent_domain/front";
