...
import { getSettings, listPendingUsers, listUsers, revokeSessionById, saveSettings, setUserStatus } from "admin_domain/server/postgres";
import { body } from "./body.js";

export function registerAdminRoutes(app: express.Express, database: PostgresDatabase): void {
