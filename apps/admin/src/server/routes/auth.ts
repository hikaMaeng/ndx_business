...
import { login, readSettings, revokeSession, signup } from "admin_domain/server/postgres";
import type { AuthenticatedRequest } from "../permission/index.js";
import { body, requireInput } from "./body.js";

export function registerAuthRoutes(app: express.Express, database: PostgresDatabase): void {
