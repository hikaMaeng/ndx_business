...
export { toEventDraft, toResultDraft, toProcessingFailureDraft } from "./ingress/event-draft.js";
...
export { attachWebSocketTransport, type GatewayWebSocketTransport } from "./transport/websocket.js";

export { createWorkerPool, runWorker, WorkerLostError, type WorkerPool, type WorkerResult } from "./worker/pool.js";
export { startWorkerEntry, type WorkerExecute } from "./worker/entry.js";
